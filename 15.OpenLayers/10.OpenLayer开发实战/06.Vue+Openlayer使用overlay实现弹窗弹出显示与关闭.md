- [Vue-OpenLayer使用overlay实现弹窗](https://www.cnblogs.com/badaoliumangqizhi/p/15540234.html)
...
这里尤其要注意的是，单击事件的回调方法中要对overplay设置其显示位置

这里不能再直接使用this.overplay.setPosition了，因为在回调函数中指针会变，此时会提示overlay为undefined。所以先重新赋值再使用
